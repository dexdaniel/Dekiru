      ...
      $(Obj).delegate('a.trigger', ev, function(ev) {
          ...
          function action(obj) {
             if (($nextEl).length && $thislink.data('state') && (o.collapsible)) {
                  ...
                  $nextEl.filter(':visible')[o.hideMethod](o.hideSpeed, function() {$thislink.data('state', 0); $(document).trigger('accordion_done');});
              }
              if (($nextEl.length && !$thislink.data('state')) || (!($nextEl).length && $thislink.closest(o.wrapper).not('.shown'))) {
                  ...
                  $nextEl.filter(':hidden')[o.showMethod](o.showSpeed, function() {$thislink.data('state', 1); $(document).trigger('accordion_done');});
              }
